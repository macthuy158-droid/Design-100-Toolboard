...
def update_tool(request: Request, slug: str, name: str=Form(...), tagline: str=Form(''), description: str=Form(''), category: str=Form(DEFAULT_TOOL_CATEGORY), platform: str=Form('Windows'), icon_text: str=Form('100'), screenshots: str=Form(''), price_yuan: float=Form(0), active: int=Form(1)):
    require_admin(request)
